...
<head>
    ...
    <title>Startups and SMEs || Empower 1XL</title>
    <?php
    ...
    <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('assets/img/breadcrumb.jpg');">
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Startups <span class="text-lowercase">and </span>SMEs</h1>
                <ul class="breadcrumb-items wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <li class="style-2">
                    Startups <span class="text-lowercase">and </span>SMEs
                    </li>
                </ul>
            </div>
        </div>
