...
<head>
    ...
    <title>Career Seekers and Job Hoppers || Empower 1XL</title>
    <?php
    ...
    <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('assets/img/breadcrumb.jpg');">
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Career Seekers <span class="text-lowercase">and</span> Job Hoppers</h1>
                <ul class="breadcrumb-items wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <li class="style-2">
                        Career Seekers <span class="text-lowercase">and</span> Job Hoppers
                    </li>
                </ul>
            </div>
        </div>
