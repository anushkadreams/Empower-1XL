...
<head>
    ...
    <title>Nonprofits and NGOs || Empower 1XL</title>
    <?php
    ...
    <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('assets/img/breadcrumb.jpg');">
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Nonprofits <span class="text-lowercase">and</span> NGOs</h1>
                <ul class="breadcrumb-items wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <li class="style-2">
                    Nonprofits <span class="text-lowercase">and</span> NGOs
                    </li>
                </ul>
            </div>
        </div>
