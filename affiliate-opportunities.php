...
<head>
    ...
    <title>Affiliate Opportunities || Empower 1XL</title>
    <?php
...
<body>
    ...
    <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('assets/img/breadcrumb.jpg');">
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Affiliate Opportunities</h1>
                        ...
                        <div class="contact-right wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <form method="POST" name="contactForm" id="contactForm" class="contact-form-items contact-form">
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-clt">
                                            <textarea name="affiliateMessage" rows="6" id="affiliateMessage" class="form-control message" placeholder="Message"></textarea>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Message validation
            const messageField = document.getElementById("affiliateMessage");
            ...
            form.addEventListener("submit", function(event) {
                ...
                fetch("https://marscms-api.mini91.com/api/affiliate", {
                        method: "POST",
                        body: JSON.stringify({
                            ...data,
