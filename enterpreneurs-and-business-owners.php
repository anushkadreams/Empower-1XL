...
<head>
    ...
    <title>Enterpreneurs and Business Owners || Empower 1XL</title>
    <?php
...
<body>
    ...
    <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('assets/img/breadcrumb.jpg');">
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Entrepreneurs <span class="text-lowercase">and</span> Business Owners</h1>
                <ul class="breadcrumb-items wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <li class="style-2">
                        Entrepreneurs <span class="text-lowercase">and</span> Business Owners
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="team-card-items">
                        ...
                        <div class="team-content">
                            <h4><a href="team-details.html">Eduardo D. Howard</a></h4>
                            <p>CEO & Founder</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="team-card-items">
                        ...
                        <div class="team-content">
                            <h4><a href="team-details.html">Jeremiah D. Marshall</a></h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="team-card-items">
                        ...
                        <div class="team-content">
                            <h4><a href="team-details.html">Jeremy B. Forsberg</a></h4>
                            <p>Senior Manager</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="team-card-items">
                        ...
                        <div class="team-content">
                            <h4><a href="team-details.html">Duane V. McCormick</a></h4>
    ...
    <section class="counter-section  section-padding mt-5 py-3">
        <div class="container">
